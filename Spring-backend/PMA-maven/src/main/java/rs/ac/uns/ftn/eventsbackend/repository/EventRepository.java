...
public interface EventRepository extends JpaRepository<Event, Long> {
	 ...
	 * 
	 * <p>
	 * The method returns events open to all within a radius of dist, with a center in coordinates (lat, lng).
	 * The call may be restricted to returning a specified number of instances as follows:
	 * 	<p>
	 * 		<code>Pageable topTen = new PageRequest(0, 10);</code>
	 * 	<br>
