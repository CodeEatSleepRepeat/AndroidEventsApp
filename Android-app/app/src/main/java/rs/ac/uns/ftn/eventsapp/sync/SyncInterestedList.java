...
public class SyncInterestedList extends AsyncTask<Void, Void, Void> {

    private InterestedEventsListFragment fragment;

    public SyncInterestedList(InterestedEventsListFragment fragment) {
