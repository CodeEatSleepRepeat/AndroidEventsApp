...
public class MessageToChatPartnerItem extends Item<GroupieViewHolder> {
    ...
    public MessageToChatPartnerItem(ChatMessage chatMessage, FirebaseUserDTO user){
    ...
    public void bind(@NonNull GroupieViewHolder viewHolder, int position) {
        ...
        final TextView messageTime =
                viewHolder.itemView.findViewById(R.id.text_view_message_date_time_item_message_to_chat_partner);
